...
.chat p::before {
    content: url("./assets/CombinedShape@1x.svg");
    margin-right: 5px;
}
.nav-bar-wrapper {
    height: 61px;
...
.left-user-data :first-child {
    font-family: Helvetica;
    font-size: 14px;
    color: #fff;
    margin: 0 0 2px 0;
}
.left-user-data :last-child {
    font-family: Helvetica;
    font-size: 12px;
    color: #9b9b9b;
    margin: 0;
...
.left-third-block div {
    width: 50%;
}
.left-third-block div :first-child {
    font-family: Helvetica;
    font-size: 20px;
    color: #fff;
    margin: 0;
}
.left-third-block div :last-child {
    font-family: Helvetica;
    font-size: 12px;
    color: #9b9b9b;
    margin: 0;
